...
public class TopResults extends Activity {
...
//Intent intent = getIntent();
     ...
     // List<BasicDocumentRevision> alldocs = globalVariable.OpenDataStore(getApplicationContext()).getAllDocuments(0, nDocs, true);
        ...
        try {
            ...
            indexManager.ensureIndexed("SigningType", "SigningType");
            Log.d("INDEX", "Created Index");
            QueryBuilder query = new QueryBuilder();
            query.index("SigningType").equalTo("SUPER");
 ...
 **/
    ...
    public void showToast(final String toast)
    {
        runOnUiThread(new Runnable() {
            public void run()
            {
                Toast.makeText(TopResults.this, toast, Toast.LENGTH_LONG).show();
               //int nDocs = datastore.getDocumentCount();
    ...
    public void myListView(final List theItems) {
        ...
        ItemAdapter adapter = new ItemAdapter(TopResults.this,Items);
...
globalVariable.setType(thisItem.getType());
                ...
                Intent i = new Intent(TopResults.this,Content.class);
